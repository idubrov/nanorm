...
public class TestGuide {
    ...
    public void testGuide() throws Exception {
        ...
        try {
            st
                    .execute("CREATE TABLE BOOKS(id INTEGER PRIMARY KEY, name VARCHAR(100), author VARCHAR(100), published DATE)");
        ...
        try {
            ...
            Book book2 = mapper.selectBook(1); // Select the book into other
                                               // bean by id
            mapper.deleteBook(book2.getId()); // Delete the book record from the
                                              // database
