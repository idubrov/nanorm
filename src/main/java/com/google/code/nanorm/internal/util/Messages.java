...
public class Messages {
        ...
        return MessageFormat
                .format(
                        "Neither column name nor column index were specified for property with subselect "
                                ...
                                + "or column name for properties with subselect.", mapping
                                .value(), resultMap.id(), mapper.getName());
    }
    ...
    public static String emptyProperty(Property mapping, Class<?> mapper, ResultMap resultMap) {
        return MessageFormat.format(
                "Empty property found in result map ''{0}'' of mapper ''{1}''", resultMap.id(),
                mapper.getName());
    }
     ...
     * @return message
     */
    public static String bothSubselectNested(Property mapping, Class<?> mapper,
            ResultMap resultMap) {
        return MessageFormat
                .format(
    ...
    public static String bothNestedGroupBy(Property mapping, Class<?> mapper, ResultMap resultMap) {
        return MessageFormat.format(
                ...
                mapping.value(), mapping.nestedMap().value(), mapper(
     ...
     * @return message
     */
    public static String mutuallyExclusive(Class<?> mapper, Method method, String ann1,
            String ann2) {
        return MessageFormat.format(
    ...
    private static String location(Class<?> mapper, Method method) {
        return location(mapper, (method == null) ? "(no method)" : method.getName());
    }
