 ...
 * 
 * TODO: Support for classcast exception (exception should contain position in
 * the property path)!
 * 
 * @author Ivan Dubrov
...
public final class AccessorBuilder implements PropertyVisitor<byte[]> {
    ...
    private void visitConstructor(Type owner) {
        GeneratorAdapter mg = new GeneratorAdapter(Opcodes.ACC_PUBLIC, ACCESSOR_CTOR, null, null,
                cw);
     ...
     * {@inheritDoc}
     */
    public Class<?> visitProperty(int pos, String property, java.lang.reflect.Method getter,
